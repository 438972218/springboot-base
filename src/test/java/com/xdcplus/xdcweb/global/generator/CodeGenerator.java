package com.xdcplus.xdcweb.global.generator;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        autoGenerator(database, username, password, host, port);

    }

    private static void autoGenerator(String database, String username,
